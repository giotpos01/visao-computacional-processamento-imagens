...
class Transform:
    """Transforma as imagens de um dataset."""
...
def load_mnist(root="../data", n=1000):
    """Carrega o dataset MNIST e cria subconjuntos de treino e validação."""
    ...
    ds_train = Subset(ds, indices[:n], Transform(MEAN, STD))
    ds_valid = Subset(ds, indices[n:], Transform(MEAN, STD))
